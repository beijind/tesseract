...
def ocr_folder(folder, file_prefix):
    for i in range(1, 26):
        start = time.time()
...
def ocr_compare(folder, with_folder):
    for i in range(1, 26):
        id = ""
...
#ocr_folder("main_images", "metai")
ocr_folder("scanned_images", "scanned")
#ocr_folder("edited_images", "metai")
print("---------------------------")
ocr_compare("main_images", "scanned_images")
#ocr_compare("main_images", "edited_images")
